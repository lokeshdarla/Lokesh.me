      ...
      <div className="w-full mb-8 text-center lg:w-1/2">
        ...
        <div className="flex flex-col items-center w-full gap-4 text-center">
          <p className="m-4 text-xl text-justify text-black font-extralight">
            Hello! I'm Lokesh Naga Sai, a computer science undergraduate at SRM University AP. I specialize in full-stack
            web development, crafting robust and user-friendly applications. My expertise extends from the back-end,
            utilizing technologies like FastAPI, to the front-end, where I design beautiful and intuitive user interfaces.
          </p>
