...
const BlogSection: React.FC<BlogSectionProps> = () => {
  ...
  return (
    <div className="flex h-screen justify-center md:items-center" id="Blog">
      <div className="relative flex flex-col items-start justify-center">
        ...
        <div className="flex items-start whitespace-nowrap border-b border-gray-200 px-5 dark:border-gray-700">
          {sections.map((section) => (
            <button
              key={section}
              onClick={() => handleSectionClick(section)}
              className={`-mb-px inline-flex h-10 items-center px-2 py-2 text-center hover:border-b-2 ${
