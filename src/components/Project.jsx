  ...
  <div className="flex flex-col-reverse items-center justify-center gap-8 p-5 sm:flex-row lg:flex-row lg:m-5">
    ...
    <div className="lg:p-5">
      <figure className="">
        ...
        <a href={previewLink} target='_blank' className="flex items-center justify-center gap-2 mt-2 text-sm text-center text-gray-400 cursor-pointer hover:underline">Preview of the website<span><RxExternalLink /></span></a>
      </figure>
    </div>
  </div>
);
